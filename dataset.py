...
class Multimodel_dataset(Dataset):
    ...
    def __getitem__(self, idx):
            ...
            cls_label = self.label_df.iloc[idx]['all']
...
if __name__ == '__main__':
    ...
    dataset = Multimodel_dataset(img_dir=r'C:\Users\li.ruili\isic\ISIC-2017_512\train\img',
                            superpixel_dir=r'C:\Users\li.ruili\isic\ISIC-2017_512\train\superpixel',
                            mask_dir=r'C:\Users\li.ruili\isic\ISIC-2017_512\train\mask',
                            excel_path=r'C:\Users\li.ruili\isic\ISIC-2017_Training_cls.csv',
